...
using DfE.EducationProviderRegistry.Web.Mvc.Search.Controllers;
using DfE.EducationProviderRegistry.Web.Mvc.Search.ViewModels;
using DfE.EducationProviderRegistry.Web.Mvc.UnitTests.Search.Controllers.TestDoubles;
using Microsoft.AspNetCore.Mvc;
using Moq;
using System.Collections.ObjectModel;

namespace DfE.EducationProviderRegistry.Web.Mvc.UnitTests.Search.Controllers;
...
public sealed class SearchControllerUnitTests
{
    ...
    public void Index_ReturnsCorrectViewAndModel()
    {
        ...
        Assert.Equal("~/Search/Views/Index.cshtml", view.ViewName);
    ...
    public async Task Search_MapsFacets_InvokesUseCase_MapsResponse_ReturnsCorrectView()
    {
        ...
        ViewResult view = Assert.IsType<ViewResult>(result);
        Assert.Equal("~/Search/Views/Results.cshtml", view.ViewName);
